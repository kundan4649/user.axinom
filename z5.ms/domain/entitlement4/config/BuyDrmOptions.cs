...
namespace z5.ms.domain.entitlement4.config
{
    ...
    public class BuyDrmMessageOptions
    {
        ...
        public TimeSpan ExpirationAfterFirstPlayDuration { get; set; } = TimeSpan.FromHours(24);
    ...
    public class BuyDrmWidevine
    {
        ...
        public TimeSpan LicenseDuration { get; set; } = TimeSpan.FromHours(24);

        /// <summary>Specifies how long (in hours) content can be played in total</summary>
        public TimeSpan PlaybackDuration { get; set; } = TimeSpan.FromHours(24);
    }
    ...
    {
        /// <summary>Persistent policy which defines how long (in hours)</summary>
        public TimeSpan PersistenceDuration { get; set; } = TimeSpan.FromHours(24);
    }
}