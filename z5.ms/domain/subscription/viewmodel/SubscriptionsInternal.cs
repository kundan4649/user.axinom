...
namespace z5.ms.domain.subscription.viewmodel
{
    ...
    public class SubscriptionsInternal
    {
        /// <summary>The total number of subscriptions found by the query.</summary>
        ...
        /// <summary>How many subscriptions should be returned per page.</summary>
        ...
        [Required]
        public List<SubscriptionInternal> SubscriptionList { get; set; } = new List<SubscriptionInternal>();
    }
}
