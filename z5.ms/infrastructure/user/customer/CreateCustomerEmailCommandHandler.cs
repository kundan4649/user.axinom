...
namespace z5.ms.infrastructure.user.customer
{
    ...
    public class CreateCustomerEmailCommandHandler : IAsyncRequestHandler<CreateCustomerEmailCommand, Result<Customer>>
    {
        ...
        /// <inheritdoc />
        public CreateCustomerEmailCommandHandler(ICustomerRepository customerRepository, IMapper mapper, IOptions<UserServiceOptions> options, IGeoIpService geoIpService)
        {
        ...
        /// <inheritdoc />
        public async Task<Result<Customer>> Handle(CreateCustomerEmailCommand message)
        {
            var customer = _mapper.Map<CreateCustomerEmailCommand, CustomerCreate>(message,
